...
function Nav() {
    const sections = [
        {section: "about_me", text: "About Me", key: 1},
    ...
    return (
        <nav>
            ...
            <div className="right">
                ...
                <Button download={false} className="contato" href="#contacts" content="Contact me" />
            </div>
        </nav>
    );
}
